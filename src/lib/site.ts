...
export const META_DESCRIPTION =
  "Digital transformation & AI consulting for SMBs, PE portfolios, and associations. One vendor for BI, software, operations, and AI agents. Built for ROI.";
